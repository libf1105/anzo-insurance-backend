...
public interface ClaimProcessRecordMapper extends BaseMapper<ClaimProcessRecord> {
    ...
    List<ClaimProcessRecord> findByClaimId(@Param("claimId") String claimId);
    ...
    List<ClaimProcessRecord> findByClaimIdAndProcessType(@Param("claimId") String claimId, @Param("processType") String processType);
    ...
    ClaimProcessRecord getLatestStatusChange(@Param("claimId") String claimId);
    ...
    List<ProcessTypeCount> getProcessTypeCounts(@Param("claimId") String claimId);
